...
CREATE INDEX "department_index" ON "courses" ("semester", "department", "number");
CREATE INDEX "title_index" ON "courses" ("semester", "title");
CREATE INDEX "requirement_id_index" ON "satisfies" ("requirement_id");
